...
public final class GLDebug {
	...
	public static int setupDebugMessageCallback(PrintStream stream) {
		...
		if (caps.OpenGL43) {
			...
			System.out.println("[GL] No debug output implementation is available, cannot return debug info.");
			return 0;
		}
	}
	...
	public static int disableDebugMessages() {
		...
		if (caps.OpenGL43) {
			...
			System.out.println("[GL] No debug output implementation is available, cannot disable debug info.");
			return 0;
		}
	}
